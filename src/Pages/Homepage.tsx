...
import svgPaths from "../imports/svg-1lr6hhp4h8";
...
function Frame5() {
  return (
    <motion.div
      whileHover={{ scale: 1.05 }}
      whileTap={{ scale: 0.95 }}
      className="bg-[rgba(227,227,227,0.72)] content-stretch flex h-[32px] items-center justify-center px-[20px] relative rounded-full shrink-0 group hover:bg-[rgba(200,200,200,0.85)] transition-colors overflow-hidden"
    >
      <Link
        to="/gco"
        className="font-['Manrope:Bold',sans-serif] font-bold leading-none relative shrink-0 text-[#292929] text-[12px] whitespace-nowrap block w-full h-full flex items-center justify-center cursor-pointer"
      >
        Global Olympiad
      </Link>
    </motion.div>
