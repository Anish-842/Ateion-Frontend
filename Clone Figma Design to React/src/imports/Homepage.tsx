...
import imgRectangle9 from "figma:asset/e54e08242e5e8cea29c382ba6bc82218d425f28e.png";
import imgImage9 from "figma:asset/3aab4451afd875f66a83eb26e0ca2d6f58abce98.png";
import imgImage7 from "figma:asset/e985b07ea1f916546c05a06ca93558ef62ecc870.png";
import imgImage775 from "figma:asset/eba887f3bcae20b7a5611026256348307e65c2c4.png";
import imgImage13 from "figma:asset/a440209918fa81a1c528e2e95290d4f1f12546e7.png";

function Frame67() {
  return (
    <div className="content-stretch flex gap-[18px] items-end relative shrink-0 w-full">
      ...
      <div className="bg-[#d9d9d9] h-[194px] shrink-0 w-[89px]" />
    </div>
  );
}
...
function Frame65() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-full">
      ...
      <div className="bg-gradient-to-b from-[#e6e6e6] from-[78.802%] h-[238px] shrink-0 to-[rgba(255,255,255,0)] w-[39px]" />
    </div>
  );
}
...
function Frame8() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-0 top-0 w-[105px]">
      <div className="bg-[rgba(227,227,227,0.72)] h-[32px] rounded-[154px] shrink-0 w-full" />
    </div>
  );
}
...
function Frame7() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0">
      <p className="font-['Manrope:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[#292929] text-[12px] whitespace-nowrap">About us</p>
    </div>
  );
}
...
function Frame9() {
  return (
    <div className="content-stretch flex flex-col h-[32px] items-start px-[23px] py-[6px] relative shrink-0 w-[105px]">
      <Frame8 />
      <Frame7 />
    </div>
  );
...
function Frame2() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0">
      <p className="font-['Manrope:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[#292929] text-[12px] whitespace-nowrap">Workshops</p>
    </div>
  );
}
...
function Frame3() {
  return (
    <div className="bg-[rgba(227,227,227,0.72)] content-stretch flex gap-[4px] h-[32px] items-center pb-[10px] pl-[12px] pr-[13px] pt-[6px] relative rounded-[154px] shrink-0 w-[105px]">
      <Frame2 />
      <div className="flex items-center justify-center relative shrink-0">
        <div className="flex-none rotate-180">
          <div className="relative size-[11px]">
            <div className="absolute bottom-1/4 left-[13.34%] right-[13.34%] top-[9.09%]">
...
function Frame5() {
  return (
    <div className="bg-[rgba(227,227,227,0.72)] content-stretch flex h-[32px] items-center justify-center pb-[10px] pl-[41px] pr-[37px] pt-[6px] relative rounded-[154px] shrink-0 w-[105px]">
      <p className="font-['Manrope:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[#292929] text-[12px] whitespace-nowrap">GCO</p>
    </div>
  );
}
...
function Frame6() {
  return (
    <div className="bg-[rgba(227,227,227,0.72)] content-stretch flex h-[32px] items-center justify-center pb-[10px] pl-[41px] pr-[31px] pt-[6px] relative rounded-[154px] shrink-0 w-[105px]">
      <p className="font-['Manrope:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[#292929] text-[12px] whitespace-nowrap">Learn</p>
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0">
      <p className="font-['Manrope:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[14.25px] text-white whitespace-nowrap">Get Connected</p>
    </div>
  );
}
...
function Frame11() {
  return (
    <div className="bg-[#fb4444] content-stretch flex flex-col h-[38px] items-start pb-[11.875px] pl-[17.813px] pr-[16.625px] pt-[7.125px] relative rounded-[182.875px] shrink-0 w-[140.125px]">
      <Frame1 />
    </div>
  );
}
...
function Frame69() {
  return (
    <div className="content-stretch flex gap-[306px] items-start relative shrink-0">
      <Group5 />
      <Frame10 />
      <Frame11 />
    </div>
...
function Frame70() {
  return (
    <div className="h-[665px] relative shrink-0 w-full">
      <div className="content-stretch flex flex-col gap-[10px] items-start px-[26px] py-[29px] relative size-full">
        <Frame68 />
        <Frame69 />
      </div>
    </div>
...
function Text() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0" data-name="text">
      <p className="col-1 font-['DM_Sans:SemiBold',sans-serif] font-['OV_Soge:Regular',sans-serif] font-semibold ml-0 mt-0 not-italic opacity-90 relative row-1 text-[0px] text-[36px] text-center text-white tracking-[0.72px] whitespace-nowrap" style={{ fontVariationSettings: "'opsz' 14" }}>
        <span className="leading-[35px]">Power By</span>
        <span className="leading-[35px]">{` `}</span>
        <span className="leading-[35px]">Proven Numbers</span>
      </p>
    </div>
  );
}
...
function Frame27() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[262px]">
      <p className="font-['DM_Sans:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[#f3ecff] text-[53px] whitespace-nowrap" style={{ fontVariationSettings: "'opsz' 14" }}>
        <span className="leading-[1.32]" style={{ fontVariationSettings: "'opsz' 14" }}>
          200+
        </span>
        <span className="leading-[1.32]">{` `}</span>
      </p>
      <p className="font-['SF_Pro_Display:Regular',sans-serif] leading-[normal] min-w-full not-italic relative shrink-0 text-[#9165ff] text-[20px] w-[min-content]">{` Institutions`}</p>
    </div>
  );
}
...
function Frame29() {
  return (
    <div className="content-stretch flex flex-col font-['DM_Sans:Regular',sans-serif] font-normal items-start leading-[1.32] relative shrink-0 w-[319px]">
      <p className="relative shrink-0 text-[#f3ecff] text-[53px] whitespace-nowrap" style={{ fontVariationSettings: "'opsz' 14" }}>
        50,000+
      </p>
      <p className="min-w-full relative shrink-0 text-[#9165ff] text-[20px] w-[min-content]" style={{ fontVariationSettings: "'opsz' 14" }}>
        Students
      </p>
    </div>
  );
...
function Frame28() {
  return (
    <div className="content-stretch flex flex-col font-['DM_Sans:Regular',sans-serif] font-normal items-start leading-[1.32] relative shrink-0 w-[210px]">
      <p className="relative shrink-0 text-[#f3ecff] text-[53px] whitespace-nowrap" style={{ fontVariationSettings: "'opsz' 14" }}>
        193 +
      </p>
      <p className="min-w-full relative shrink-0 text-[#9165ff] text-[20px] w-[min-content]" style={{ fontVariationSettings: "'opsz' 14" }}>
...
function Frame30() {
  return (
    <div className="content-stretch flex gap-[143px] items-center relative shrink-0 w-full">
      <Frame27 />
      <Frame29 />
      <Frame28 />
    </div>
...
function Frame42() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-[1032px]">
      <Frame60 />
    </div>
  );
}
...
function Frame61() {
  return (
    <div className="content-stretch flex flex-col gap-[33px] items-end relative shrink-0 w-full">
      <Frame42 />
      <div className="aspect-[1280/531] relative shrink-0 w-full" data-name="image 775">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[111.68%] left-[-0.04%] max-w-none top-0 w-[100.08%]" src={imgImage775} />
        </div>
      </div>
    </div>
  );
...
function Frame59() {
  return (
    <div className="content-stretch flex flex-col items-end relative shrink-0 w-[1056px]">
      <Frame61 />
    </div>
  );
}
...
function Frame62() {
  return (
    <div className="bg-black h-[846px] relative rounded-[12px] shrink-0 w-full">
      <div className="content-stretch flex flex-col items-start pb-[91px] pl-[100px] pr-[124px] pt-[97px] relative size-full">
        <Frame59 />
      </div>
    </div>
  );
...
function Frame44() {
  return (
    <div className="content-stretch flex items-center justify-between leading-[0] not-italic relative shrink-0 text-black w-full">
      <p className="font-['OV_Soge:Medium',sans-serif] relative shrink-0 text-[0px] text-[48px] w-[420px]">
        <span className="font-['OV_Soge:Semi_Bold',sans-serif] leading-[63px]">Education is not broken.</span>
        <span className="leading-[63px]">{` `}</span>
      </p>
      <p className="font-['SF_Pro_Display:Regular',sans-serif] relative shrink-0 text-[20px] w-[377px]">
        <span className="leading-[28px]">{`Its measurement system is `}</span>
        <span className="font-['SF_Pro_Display:Bold',sans-serif] leading-[28px]">outdated.</span>
        <span className="leading-[28px]">{` Ateion replaces memory-based validation with `}</span>
        <span className="font-['IBM_Plex_Sans:Bold_Italic',sans-serif] italic leading-[28px]">capability-based intelligence.</span>
      </p>
    </div>
  );
}
...
function Frame73() {
  return (
    <div className="col-1 content-stretch flex flex-col gap-[40px] items-start ml-0 mt-0 relative row-1 w-[1188px]">
      <Frame44 />
      <Frame41 />
    </div>
  );
...
function Frame74() {
  return (
    <div className="content-stretch flex flex-col gap-[85px] items-center relative shrink-0 w-full">
      <Frame72 />
      <Group6 />
    </div>
  );
...
function Frame36() {
  return (
    <div className="content-stretch flex flex-col gap-[11px] items-start relative shrink-0 w-full">
      <p className="font-['OV_Soge:Semi_Bold',sans-serif] leading-[1.19] not-italic relative shrink-0 text-[40px] text-black tracking-[0.4px] w-[544px]">Global Capability Olympiad</p>
      <Frame31 />
    </div>
  );
}
  ...
  return (
    <div className="col-1 content-stretch flex flex-col gap-[32px] items-start ml-0 mt-0 relative row-1 w-[392px]">
      ...
      <div className="h-[51px] relative shrink-0 w-[168px]" data-name="view more">
        ...
        <p className="absolute font-['OV_Soge:Medium',sans-serif] inset-[27.27%_35.12%_14.55%_11.31%] leading-[31.5px] not-italic text-[16px] text-white tracking-[0.16px] whitespace-nowrap">View More</p>
...
function Group7() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      ...
      <p className="col-1 font-['OV_Soge:Semi_Bold',sans-serif] leading-[normal] ml-[546.87px] mt-[208.5px] not-italic relative row-1 text-[21.13px] text-white whitespace-nowrap">Ateion</p>
      <p className="col-1 font-['SF_Pro_Display:Regular',sans-serif] leading-[normal] ml-[547.87px] mt-[248.11px] not-italic relative row-1 text-[12.326px] text-white w-[192.811px]">From early AI workshops to the Global Capability Olympiad, and emerging initiatives like KRONOS and VOUCH Ateion is building the infrastructure for a capability-based future.</p>
      <p className="col-1 font-['SF_Pro_Display:Regular',sans-serif] leading-[normal] ml-[434.15px] mt-[513.61px] not-italic relative row-1 text-[14.087px] text-black w-[162.195px]">{`From early AI workshops to the Global Capability Olympiad, and emerging initiatives like KRONOS and VOUCH `}</p>
      <p className="col-1 font-['SF_Pro_Display:Regular',sans-serif] leading-[normal] ml-[740.52px] mt-[472.56px] not-italic relative row-1 text-[14.087px] text-black w-[162.195px]">{`From early AI workshops to the Global Capability Olympiad, and emerging initiatives like KRONOS and VOUCH `}</p>
      <p className="col-1 font-['SF_Pro_Display:Regular',sans-serif] leading-[normal] ml-[879.69px] mt-[205.24px] not-italic relative row-1 text-[14.087px] text-black w-[162.195px]">{`From early AI workshops to the Global Capability Olympiad, and emerging initiatives like KRONOS and VOUCH `}</p>
      <p className="col-1 font-['SF_Pro_Display:Regular',sans-serif] leading-[normal] ml-[289px] mt-[126px] not-italic relative row-1 text-[14.087px] text-black w-[162.195px]">{`From early AI workshops to the Global Capability Olympiad, and emerging initiatives like KRONOS and VOUCH `}</p>
      <p className="col-1 font-['OV_Soge:Bold',sans-serif] leading-[normal] ml-[289px] mt-[86px] not-italic relative row-1 text-[32px] text-black whitespace-nowrap">GCO</p>
      <p className="col-1 font-['OV_Soge:Bold',sans-serif] leading-[normal] ml-[434px] mt-[485px] not-italic relative row-1 text-[19.93px] text-black whitespace-nowrap">Kronos</p>
      <p className="col-1 font-['OV_Soge:Bold',sans-serif] leading-[normal] ml-[876.15px] mt-[182.08px] not-italic relative row-1 text-[16.71px] text-black w-[106.53px]">Workshops</p>
      <p className="col-1 font-['OV_Soge:Bold',sans-serif] leading-[normal] ml-[735.28px] mt-[445.33px] not-italic relative row-1 text-[19.93px] text-black whitespace-nowrap">Vouch</p>
      <Group2 />
      <p className="col-1 font-['OV_Soge:Semi_Bold',sans-serif] ml-[721px] mt-[5px] not-italic opacity-90 relative row-1 text-[36px] text-black w-[396px]">
...
function Group1() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      <p className="col-1 font-['OV_Soge:Semi_Bold',sans-serif] leading-[1.19] ml-0 mt-0 not-italic relative row-1 text-[32px] text-black text-center whitespace-nowrap">Your Common Questions Answered</p>
    </div>
  );
}
...
function Frame32() {
  return (
    <div className="content-stretch flex flex-col gap-[43px] items-center relative shrink-0 w-[1044.984px]">
      <Group1 />
      <Frame45 />
    </div>
  );
...
function Frame75() {
  return (
    <div className="content-stretch flex flex-col gap-[134px] items-center relative shrink-0 w-[1158px]">
      <Group7 />
      <Frame32 />
    </div>
  );
...
function Frame76() {
  return (
    <div className="content-stretch flex flex-col gap-[155px] items-center relative shrink-0 w-full">
      <Frame74 />
      <Frame75 />
    </div>
  );
...
function Frame24() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
      <p className="font-['Lato:Regular',sans-serif] leading-[1.3] not-italic relative shrink-0 text-[15.78px] text-black w-[209.734px]">Ateion Pvt. Ltd.</p>
    </div>
  );
}
...
function Frame18() {
  return (
    <div className="content-stretch flex flex-col gap-[14.848px] h-[136.42px] items-start relative shrink-0 w-[115.494px]">
      <Frame17 />
      <Frame16 />
      <Frame15 />
    </div>
...
function Frame26() {
  return (
    <div className="content-stretch flex gap-[186.533px] items-start relative shrink-0 w-full">
      <Original />
      <Frame20 />
      <Frame21 />
    </div>
...
function Frame22() {
  return (
    <div className="bg-[#f7f3eb] h-[338.73px] relative shrink-0 w-full">
      <div className="content-stretch flex flex-col items-start pb-[33.409px] pt-[18.561px] px-[115.075px] relative size-full">
        <Frame25 />
        <Frame26 />
      </div>
    </div>
...
function Frame12() {
  return (
    <div className="bg-[#1e1632] h-[47.329px] relative shrink-0 w-full">
      <div aria-hidden="true" className="absolute border-[#e4e4e4] border-solid border-t-[4.64px] inset-[-4.64px_0_0_0] pointer-events-none" />
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center p-[7.424px] relative size-full">
          <p className="font-['Lato:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[12.99px] text-center text-white w-[679.315px]">Copyright ©Ateion 2026. All Rights Reserved.</p>
        </div>
      </div>
    </div>
  );
...
function Frame77() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[98px] items-start left-[-1px] top-0 w-[1283px]">
      <Frame76 />
      <div className="h-[391.409px] shrink-0 sticky top-0 w-[1283px]">
        <div className="absolute inset-[46.39%_86.61%_51.66%_12.58%]" data-name="Vector">
          <div className="absolute inset-[-7.05%_-5.15%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11.5122 8.70697">
              <path d={svgPaths.p36f83400} id="Vector" stroke="var(--stroke-0, #A2A2A2)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.07533" />
            </svg>
          </div>
        </div>
        <Frame13 />
